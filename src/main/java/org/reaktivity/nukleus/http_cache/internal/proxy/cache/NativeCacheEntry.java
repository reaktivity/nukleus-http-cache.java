...
public final class NativeCacheEntry extends CacheEntry
{
            ...
            switch(msgTypeId)
            {
                case WindowFW.TYPE_ID:
                    ...
                    if (payloadWritten == cachedRequest.responseSize() && ackedBudget)
                    {
                        ...
                        NativeCacheEntry.this.cache.writer.doHttpEnd(acceptReply, acceptRouteId, acceptReplyStreamId,
                                                                       window.trace());
                        this.onEnd.run();
