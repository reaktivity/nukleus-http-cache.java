...
import org.reaktivity.nukleus.http_cache.internal.HttpCacheNukleus;
...
{
    private static final DirectBuffer SOURCE_NAME_BUFFER = new UnsafeBuffer(HttpCacheNukleus.NAME.getBytes(UTF_8));
